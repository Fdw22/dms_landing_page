<footer class="mt-32" style="background-color: rgba(37, 38, 65, 1);">
    <div class="max-w-lg mx-auto">
        <div class="flex py-12 justify-center text-white items-center px-20 sm:px-36">
            <div class="relative">
                <!-- <h1 class="font-bold text-xl pr-5 relative z-50">ProVue</h1> -->
                ...
                <img src="/img/logo/provue_logo.png" class="w-100 pr-5 relative z-50" alt="">
            </div>
            <span class="border-l border-gray-500 text-sm pl-5 py-2 font-semibold">Document Management System</span>
        </div>
        ...
        <div class="text-center text-white">
            <p class="my-3 text-gray-400 text-sm">&copy; 2023 PT. Infomedia Nusantara </p>
